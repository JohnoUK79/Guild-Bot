...
module.exports = {
    ...
    async execute(oldPresence, newPresence) {
        ...
        //     newPresenceUpdate = sql.Execute(`INSERT INTO presence (date, guild_name, member_name, old_presence, new_presence) VALUES ('${setDate}', "${newPresence.guild.name}","${newPresence.member.displayName}",'No Prior Status','${newPresence.status}')`)
