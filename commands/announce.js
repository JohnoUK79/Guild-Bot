...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const announceEmbed = new EmbedBuilder()
            ...
            .setAuthor({ name: 'Battle-Bot Announcement', iconURL: 'http://battle-bot.com/img/gifs/Influencer.gif'})
            .setThumbnail('http://battle-bot.com/img/gifs/Influencer.gif')
            .addFields(
                { name: `Announcement`, value: `${message}` },
            )
            .setTimestamp()
            .setFooter({ text: `Announcement.`, iconURL: `http://battle-bot.com/img/gifs/Influencer.gif` });
